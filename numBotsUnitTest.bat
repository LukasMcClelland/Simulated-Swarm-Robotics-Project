::             gui   #Bots #numEquip visionRadius commDelay timeout negPriority commsON
python main.py noGUI 1     50        50           100       10      -100        True
python main.py noGUI 1     50        50           100       10      -100        True
python main.py noGUI 1     50        50           100       10      -100        True
python main.py noGUI 2     50        50           100       10      -100        True
python main.py noGUI 2     50        50           100       10      -100        True
python main.py noGUI 2     50        50           100       10      -100        True
